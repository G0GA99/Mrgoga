...
export const SOCIALS_CONTACT = [
  ...
  { name: 'Reddit',    href: 'https://reddit.com/r/g0gaaiagency'         },
]
  ...
  return (
    <a
      ...
      style={{
        ...
        background: icon.bg,
        boxShadow: `0 4px 14px ${icon.shadow}, 0 1px 0 rgba(255,255,255,.15) inset`,
        transition: 'transform .18s ease, box-shadow .18s ease',
        flexShrink: 0,
      }}
      onMouseEnter={e => {
        e.currentTarget.style.transform = 'translateY(-3px) scale(1.10)'
        e.currentTarget.style.boxShadow = `0 10px 24px ${icon.shadow}, 0 1px 0 rgba(255,255,255,.15) inset`
      }}
      onMouseLeave={e => {
        e.currentTarget.style.transform = 'translateY(0) scale(1)'
        e.currentTarget.style.boxShadow = `0 4px 14px ${icon.shadow}, 0 1px 0 rgba(255,255,255,.15) inset`
      }}>
      <svg viewBox="0 0 24 24" width={size * 0.48} height={size * 0.48} fill="white">
        <path d={icon.path} />
      </svg>
    </a>
  )
