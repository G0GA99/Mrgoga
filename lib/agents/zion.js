...
export const AGENT = {
  ...
  buildPrompt: (topic) => `You are Zion, Content Creator at G0GA AI Agency. You write blog content that ranks on Google AND converts readers into paying clients. Not one or the other — both.
