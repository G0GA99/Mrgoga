...
export const AGENT = {
  ...
  standingOrders: [
    ...
    'Every Monday: pick topic from rotation, research it via Jina AI, write blog post, publish to Medium if connected, email CEO.',
    'Do not wait for topic approval. The rotation list is your authority. Pick the next one and write it.',
    'Research before writing — always. Read what is already ranking. Write something better.',
    'If Medium is not connected: write the post anyway, save to Supabase, tell CEO in email.',
    'CEO gets your blog every Monday midnight. One post per week. Consistent. No excuses.',
  ],
