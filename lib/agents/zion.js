...
export const AGENT = {
  ...
  standingOrders: [
    'You run automatically every Monday at midnight PKT alongside Kai. No approval needed.',
    'Every Monday: pick the next content type from the rotation. Research. Write. Publish where possible.',
    'Do not wait for topic approval. The rotation is your authority.',
    'Research before writing — always. Read what is already ranking. Write something better.',
    'Content types rotate weekly: Blog Post → LinkedIn Article → Case Study → Newsletter → SEO Page → repeat.',
  ...
  topics: {
    ...
    linkedin_article: [
      'The agency that doubled my conversions without touching my ads — here\'s what they built',
      'Why I stopped using off-the-shelf software and hired an AI agency instead',
      '3 things most businesses get wrong about AI chatbots (and the fix)',
      'We built a $10,000 AI dashboard for a retail chain. Here is what we learned.',
      'How G0GA helps small businesses compete with companies 10x their size',
    ],
    case_study: [
      'How a local restaurant gained 30% more reservations with an AI booking chatbot',
      'How a UK law firm reduced admin work by 15 hours/week using automation',
      'How a Canadian real estate agent closed 2x more leads with an AI follow-up system',
      'How a gym in USA stopped losing members with automated check-in and reminders',
      'How a Shopify store owner saved $2,000/month by automating customer support',
    ],
    newsletter: [
      'This week in AI: what changed and what it means for your business',
      'The one AI tool you probably haven\'t tried yet (and why it works)',
      'A real conversation: how one client went from 0 to 80 qualified leads in a month',
      'AI vs hiring: when does automation beat a full-time employee?',
      'G0GA update: new service, new results, new proof',
    ],
    seo_page: [
      'AI chatbot development for restaurants in USA — G0GA',
      'Custom AI automation for law firms — G0GA',
      'E-commerce AI assistant development — G0GA',
      'AI dashboard and data analytics for small business — G0GA',
      'AI web development agency UK and Canada — G0GA',
    ],
  },
...
ABOUT G0GA: AI agency. Services: custom websites ($1500-$4000), AI chatbots and automation ($2000-$6000), branding ($100-$400), 3D product visuals ($5000-$8000), data dashboards ($3000-$10000). Website: g0ga.vercel.app.
...
ABOUT G0GA: AI agency building custom websites, AI chatbots, automation, and data dashboards for businesses in USA, UK, Canada. Website: g0ga.vercel.app.
...
ABOUT G0GA: AI agency. We build real solutions. These are composite examples based on typical client results.
...
ABOUT G0GA: AI agency. g0ga.vercel.app | WhatsApp: +923091989556
...
ABOUT G0GA: AI agency. Custom websites ($1500-$4000), AI chatbots ($2000-$6000), automation, branding, dashboards. Serving USA, UK, Canada.
