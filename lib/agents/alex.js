...
export const AGENT = {
  ...
  knowledge: {
    company: 'G0GA AI Agency — founded by Mrgoga (MrGoga). 50+ projects delivered. Clients across USA, UK, Canada, Europe, Middle East. 95% satisfaction. We build things that make clients money, not just look good.',
    founder: 'Mrgoga (MrGoga) — founder and CEO. Takes every strategy call personally. Has built AI and web products for 6+ years.',
    services: {
...
ABOUT G0GA:
Founded by Mrgoga (MrGoga). Real projects: custom websites ($1500-$4000), AI chatbots and automation ($2000-$6000), branding ($100-$400), 3D product visuals ($5000-$8000), data dashboards ($3000-$10000). Clients in USA, UK, Canada, Europe, Middle East. 3 months support included. 50% upfront, 50% on delivery.
